    ...
    <div className="p-6 max-w-5xl mx-auto">
      <div className="mb-6">
        ...
        <div className="flex justify-between mb-4">
          {[" order Details" ,"Customer Details", "Eligibility Check", "Order Processing",
            "Review Details "
          ].map((step, index) => (
            <div key={index} className={`flex items-center gap-2 ${currentStep === index + 1 ? "text-[#012F76] font-bold" : "text-gray-500"}`}>
              <div
                className={`w-8 h-8 flex items-center justify-center rounded-full ${
                  currentStep === index + 1 ? "bg-[#012F76] text-white" : "bg-gray-300"
                }`}
              >
                {index + 1}
              </div>
...
{currentStep === 2 && (
  <section className="mb-6">
    <h2 className="text-lg font-semibold bg-[#BFE3FD] px-3 py-4 mb-4">
      <span className="bg-[#012F76] text-white rounded-full px-3 py-1 mr-2">2</span>
      Customer Details
    </h2>
    <div className="grid md:grid-cols-3 gap-4">
      <div>
        <label className="block text-sm font-medium text-gray-700">Traveller's Name</label>
        <input
          type="text"
          className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2"
          placeholder="Enter Name"
    ...
    <div className="grid md:grid-cols-3 gap-4 mt-4">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700">Select Country You're Traveling To</label>
        <select className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
          <option>Select Country</option>
          <option>USA</option>
          <option>Canada</option>
...
<section>
  ...
  <div className="py-10">
    <input type="checkbox" id="visa-requirement" className="mr-4" />
    <label htmlFor="visa-requirement" className="text-[#6E7491]">
      Click here in case you do not require a Visa or if you will receive a Visa
      on arrival.
    </label>
    <div>
      ...
      <label htmlFor="visa-requirement-1" className="text-[#6E7491]">
        I confirm that I’m in possession of valid documents as per the list
        shown above and that I haven’t bought or transferred foreign currency
        for more than USD 2,50,000 (or equivalent in another currency) in the
    ...
    <div className="flex  justify-end">
      ...
      <div className="flex justify-between">
        <button
          ...
          className={`px-4 py-2 rounded-full ${currentStep === 1 ? "bg-gray-300 text-gray-500 cursor-not-allowed" : "bg-[#012F76] text-white"}`}
        >
          Previous
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-full ${currentStep === 5? "bg-gray-300 text-gray-500 cursor-not-allowed" : "bg-[#012F76] text-white"}`}
        >
          Next
        </button>
      </div>
