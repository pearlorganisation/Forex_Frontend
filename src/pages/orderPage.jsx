...
const MultiStepForm = () => {
  ...
  console.log("enquriy data", state);
  //  /api/Forex/=575eaab8-a85a-40c8-be98-b426562d75c2

  const fetchTransferMoney = async () => {
    const response = await instance.get(
      `/api/Forex/GetRequestData?Enquiryno=${state?.Enquiryno}`
    );
  ...
  useEffect(() => {
    ...
    if (data?.RequestCode) {
      switch (data.RequestCode) {
        case 1:
          setCurrentComponent(<ExchangeCurrency />);
          break;
        case 2:
          setCurrentComponent(<TransferMoney />);
          break;
        case 3:
          setCurrentComponent(<ReloadUnloadForexCards />);
          break;
        case 4:
          setCurrentComponent(<InternationalSimCards />);
          break;
        case 5:
          setCurrentComponent(<TravelInsurance />);
          break;
        default:
          setCurrentComponent(<p>No data available</p>);
      }
    } 
  }, []); 
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
            ...
            >
              <div
                className={`w-8 h-8 flex items-center justify-center rounded-full ${
                  currentStep === index + 1
                    ? "bg-[#012F76] text-white"
                    : "bg-gray-300"
                }`}
              >
                {index + 1}
              </div>
              <span className="text-center">{step}____</span>
            </div>
          ))}
        </div>
      </div>
        ...
        <section className="mb-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div>
                ...
                <input
                  ...
                  {...register("foreignAmount", {
                    required: "Foreign Currency Amount is required",
                  })}
                  className="mt-1 block w-full border-gray-300 border rounded-md shadow-sm p-2"
                  placeholder="Enter Foreign Currency Amount"
                />
            ...
            <div className="flex justify-end">
              <button
                type="button"
                className="mt-4 bg-[#012F76] text-white px-4 py-2 rounded-full"
              >
                + Add Product
              </button>
            </div>
            ...
            <div className="overflow-x-auto p-4">
              <table className="min-w-full table-auto border-collapse">
                ...
                <tbody>
                  {data?.enquirydata?.map((row, index) => (
                    <tr key={index} className="border-b">
                      <td className="px-6 py-4 text-sm text-gray-700">
                        {row.RecCurrency}
                      </td>
           ...
           <div className="flex justify-end mt-4">
              <button
                type="submit"
                className="bg-[#63E830] text-white px-4 py-2 rounded-md"
              >
                Submit Order
              </button>
            </div>
      ...
      {currentStep === 2 && (
        <section className="mb-6">
          <h2 className="text-lg font-semibold bg-[#63696d] px-3 py-4 mb-4">
            <span className="bg-[#012F76] text-white rounded-full px-3 py-1 mr-2">
              2
            </span>
            Customer Details
      ...
      {currentStep === 3 && (
        <section>
          ...
          <div className="py-10">
            <input type="checkbox" id="visa-requirement" className="mr-4" />
            <label htmlFor="visa-requirement" className="text-[#6E7491]">
              Click here in case you do not require a Visa or if you will
              receive a Visa on arrival.
            </label>
            <div>
              <input type="checkbox" id="visa-requirement-1" className="mr-4" />
              <label htmlFor="visa-requirement-1" className="text-[#6E7491]">
                I confirm that I’m in possession of valid documents as per the
                list shown above and that I haven’t bought or transferred
                foreign currency for more than USD 2,50,000 (or equivalent in
                another currency) in the current financial year.
              </label>
            </div>
          </div>
        </section>
        ...
        <section className="mb-6">
          ...
          <div className="grid  md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="text"
                className="mt-1 block w-full sm:w-48 lg:w-96 border border-gray-300 rounded-md shadow-sm p-2"
                Responsive
                width
                for
                phone
            ...
            <div className="p-8 bg-gray-100">
              ...
              <div className="bg-white shadow-md rounded-lg p-6 space-y-8">
                ...
                <div>
                  ...
                  <div className="flex  md:flex-row  flex-col items-center md:w-[450px] border p-4 rounded-lg shadow-sm">
                    <div className="md:w-[297px]">
                      ...
                      <p className="text-sm text-gray-600 mt-2 ">
                        Save tons on your international voice & data usage. Get
                        up to 50% off on international SIM cards on BookMyForex.
                      </p>
                      <p className="text-sm font-semibold mt-2">
                        Plans Starting From:{" "}
                        <span className="text-black">$128</span>
                ...
                <div className="flex flex-col md:flex-row justify-between">
                  ...
                  >
                    <h3 className="text-lg font-semibold mb-4 rounded-md px-4 py-3">
                      Your Order Summary
                    </h3>
                    <div className="p-4 rounded-lg shadow-sm">
                      <div className="flex justify-between py-2">
          ...
          <section>
            <div className="p-8 bg-gray-100">
              ...
              <div className="bg-white shadow-md rounded-lg p-6 space-y-6">
                ...
                <div>
                  <h3 className="text-[#012F76] font-bold">
                    Select a Payment Mode From The Options Below
                  </h3>
                </div>
                ...
                <div className="flex flex-row items-center gap-4">
                  <div>
                    <img src="public/assets/cart.png" alt="" className="w-10" />
                  </div>
                  <div>
                    <div>Total Amount Payable:</div>
                    <div>$170,623.00</div>
                ...
                <div className="text-[#012F76] bg-[#ECF7FE] px-10 py-6">
                  The payment must come from a savings account belonging to the
                  customer. In case the payment is made from a joint account,
                  please provide us with a copy of a cancelled cheque or a copy
                  of your passbook/bank statement confirming that your account
                  is a joint account. Transfer instructions would be provided to
                  you via email after you complete your order booking.
                </div>

                <h1 className="text-[#012F76] text-2xl px-8 py-6 font-semibold">
                  Lock-in Your Exchange Rates
                </h1>
                <div className="text-[#012F76] bg-[#ECF7FE] px-10 py-6">
                  To complete your order, a deposit worth 2% of your order total
                  needs to be paid now to fix the exchange rates for 3 working
                  days (including today). This deposit will be refunded in full,
                  back to the original source of payment within 12 working hours
                  of order completion and may take up to 7 working days to
                  reflect. This deposit will be forfeited in case of explicit
                  cancellations or non-compliance with regulatory requirements
                  and/or reasons as mentioned in our cancellation policy.
                  <div className="flex flex-row items-center gap-4">
                    <div>
                      <img
                ...
                <div className="max-w-4xl mx-auto p-4">
                  ...
                  <div className="mb-4">
                    <div className="flex items-center space-x-4 p-3 bg-green-100 rounded-md border border-[#43e305]">
                      ...
                      />
                      <p className="text-sm">
                        Make your payments for the advance deposit using UPI and
                        enjoy same day refund*
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mb-4 bg-green-100 p-3 rounded-md border border-[#43e305]">
                    <p className="text-sm">
                      Have you purchased or transferred foreign currency worth
                      more than INR. 700,000 in the present financial year
                  ...
                  <div className="mb-4 bg-green-100 p-3 rounded-md border border-[#43e305]">
                    <p className="text-sm">
                      * Payment is directly made to the account of the assigned
                      authorized dealer responsible for executing the forex
                      order. Please note that BookMyForex does not collect money
                      on behalf of the vendor under any circumstances.
                    </p>
                  </div>
                  ...
                  <div className="mb-4">
                    <label className="flex items-start space-x-2">
                      ...
                      />
                      <span className="text-sm">
                        I, ABHINAV SINGH, agree to abide by the terms of use,
                        confirm the accuracy of the provided information, and
                        acknowledge that I am obligated to pay 2% of order total
                        as cancellation charges in the event of order
                        cancellation as outlined in BookMyForex’s cancellation
                        policy.
                      </span>
                    </label>
                  </div>
                  ...
                  {/* Refund Notice */}
                  <p className="text-sm text-gray-600 mb-4">
                    Same day refund is not applicable when UPI payment is made
                    via @paytm* vpa
                  </p>
                  ...
                  <div className="flex  justify-end">
                    <button
                      className="mt-4 bg-[#012F76] text-white px-20 md:px-32 py-3 rounded-full hover:bg-blue-900 "
                      isabled={!isChecked}
                    >
                      Pay Now
                    </button>
